"use client";
import { calculateTotalExpensesMultiCurrency, calculateTotalExpensesByCurrency, calculateDailyAllowance, getExchangeRateForCurrency, Delegation, Expense } from '@/logic/rules';
    ...
    <div className="card p-6 space-y-6">
      ...
      <div className="space-y-3">
        ...
        <div className="flex justify-between items-center text-neutral-600">
          ...
          <span className="font-semibold text-neutral-900">{totalAllowance.toFixed(2)} PLN</span>
        </div>
